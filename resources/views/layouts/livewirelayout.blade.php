...
<head>
    ...
    <script>
        function ItemsList(e) {
            ...
            e.name === 'items' ? (e.name = "closeitems", list.classList.add('grid'), list.classList.remove('-md:hidden')) :
                (e.name = "items", list.classList.add('-md:hidden'), list.classList.remove('grid'));
        }
    </script>
    @stack('scripts')
