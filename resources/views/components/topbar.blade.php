...
<body class="bg-blue-500">
	<nav class="relative nav-blur px-4 py-4 flex justify-between items-center sticky top-0 z-10 mb-4">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:space-x-2">
			...
			<li><a class="text-sm text-gray-400 hover:text-teal-700" href="{{ route('prebuilt') }}">Lastest Prebuilt</a></li>
		</ul>
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div>
				<ul class="font-archivo">
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-teal-50 hover:text-teal-600 rounded" href="{{ route('custom-keyboard') }}">Custom Keyboard</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-teal-50 hover:text-teal-600 rounded" href="#">Keyboard Repair</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-teal-50 hover:text-teal-600 rounded" href="#">Keyboard Mod</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-teal-50 hover:text-teal-600 rounded" href="#">Parts Store</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-teal-50 hover:text-teal-600 rounded" href="{{ route('ai-suggestion') }}">AI Suggestion</a>
					</li>
					<li class="mb-1">
