<nav class="p-4 fixed w-full bg-[#E8F4FA] md:flex md:items-center md:justify-center md:p-0 md:pt-24">
    ...
    <ul class="absolute w-full border-b-1 border-black left-0 pl-6 pb-6 opacity-0 top-[-400px] md:opacity-100 md:border-none md:flex md:items-center md:z-auto md:static md:pb-0 md:w-auto md:space-x-6 lg:space-x-16 xl:space-x-28">
        <li class="m-4">
