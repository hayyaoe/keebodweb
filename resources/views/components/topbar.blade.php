...
<body class="bg-blue-500">
	<nav class="relative nav-blur px-4 py-4 flex justify-between items-center sticky top-0 z-10 mb-4">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:space-x-2">
			<li><a class="text-sm text-gray-400 hover:text-teal-700" href="#">Custom Keyboard</a></li>
			...
			<li><a class="text-sm text-gray-400 hover:text-teal-700" href="#">AI Suggestion</a></li>
      <li class="text-gray-300">
				|
			</li>
