...
@include('components/topbar')
    <div class= "fixed flex h-full w-full items-center justify-center bg-gray-100 top-0 left-0">
        <div class="bg-white h-fit rounded-lg shadow-lg p-6 flex flex-col w-100">
            <!-- Cart Header -->
            <h2 class="text-2xl font-extrabold tracking-tight leading-none font-archivo mb-6">{{ Auth::user()->name }}'s Cart</h2>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
                    <div class="ml-0 flex-1">
                        ...
                        <p class="text-gray-600 mb-2">{{ $customOrder->type->name }} | {{ $customOrder->caseType->name }} | {{ $customOrder->keyswitch->name }} | {{ $customOrder->keycap->name }} | {{ $customOrder->connection->name }} | {{ $customOrder->assembly->name }}</p>
                        <div class="flex items-center justify-between">
                            <p class="text-lg font-semibold">Rp{{ $prices[$index] }}</p>
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg shadow-sm">
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="text-gray-800">Rp{{ $subtotal }}</span>
                </div>
                <div class="flex justify-between mb-2">
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="text-gray-800">Rp{{ $tax }}</span>
                </div>
                <div class="flex justify-between font-semibold">
                    <span class="text-gray-800">Total</span>
                    <span class="text-gray-900">Rp{{ $total }}</span>
                </div>
            </div>
