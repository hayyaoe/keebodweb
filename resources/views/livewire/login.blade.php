...
<div>
  ...
  <form wire:submit.prevent="login">
      ...
      <div class="flex flex-col md:flex-row h-screen relative">
          ...
          <div class="w-full md:w-2/3 flex items-center justify-center mx-auto relative border-r border-black">
              <div class="absolute inset-0 bg-cover bg-center filter blur-lg" style="background-image: url('{{ asset('images/KeeBod2.png') }}');"></div>
              <div class="relative z-10">

                <div class="bg-white p-20 border border-black">

                  <h1 class="w-80 text-4xl max-w-2xl mb-4 font-extrabold tracking-tight leading-none font-archivo">
                      Welcome back KeeBoders
                  </h1>
